...
const LessonController = {
  createLesson: async (req, res) => {
    try {
      const { ModuleID, Title, Type, ContentUrl, ContentHtml, Duration, OrderIndex, Describe, Summary, score } = req.body;
      ...
      await pool.query(
        `UPDATE Lessons
         SET Title = $2, Type = $3, ContentUrl = $4, ContentHtml = $5,
             Duration = $6, OrderIndex = $7, "describe" = $8, "summary" = $9, score = $10
         WHERE LessonID = $1`,
        [
          parseInt(id),
          Title,
